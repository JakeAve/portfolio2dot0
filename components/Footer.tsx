export function Footer() {
  return (
    <footer class="relative pt-16 pb-12 bg-white dark:bg-gray-800">
      <div class="absolute left-0 z-10 w-full h-24 bg-white bg-gray-100 rounded-full dark:bg-gray-800 -top-10"></div>
      ...
      <a href="https://fresh.deno.dev" target="_blank">
        ...
        <span class="dark:text-white">&copy; {new Date().getFullYear()} JakesPortfolio.dev</span>
      </div>
    </footer>
  );
}
