export function SocialIcons() {
  return (
    <div class="absolute flex items-center justify-center top-4 right-4 gap-2">
      <a
        ...
        title="Blog"
        aria-label="Blog"
        class="p-2 bg-black rounded-full dark:bg-white dark:bg-opacity-50 bg-opacity-50 hover:bg-opacity-100"
      >
        <svg
